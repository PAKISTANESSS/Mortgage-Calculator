export default {
  // Navigation
  navTitle: 'Hypothekenrechner',
  monthlyPaymentCalc: 'Monatliche Zahlungsrechner',
  ...
  houseInsurance: 'Hausversicherung',
  perMonth: '€/Monat',
  ...
  recalculateYes: '✓ Die Zahlung sinkt jeden Monat, wenn sich der Saldo reduziert (Sie zahlen insgesamt weniger Zinsen)',
  recalculateNo: '✗ Die Zahlung bleibt fest, das Darlehen endet früher (Standard-Hypothekenverhalten)',
  recurring: 'Wiederkehrend',
  oneTime: 'Einmalig',
  month: 'Monat',
  year: 'Jahr',
  monthsOption: 'Monat(e)',
  yearsOption: 'Jahr(e)',
  every: 'Alle',
  ...
  balanceDesc: 'Vergleichen Sie, wie zusätzliche Tilgungszahlungen Ihren Darlehenssaldo im Laufe der Zeit reduzieren.',
  totalPaymentBreakdown: 'Gesamtzahlungsaufschlüsselung',
  ...
  amortizationCalcSubtitle: 'Detaillierten Darlehenstilgungsplan anzeigen',
