export default {
  // Navigation
  navTitle: 'Outils Hypothécaires',
  monthlyPaymentCalc: 'Calculatrice de Paiement Mensuel',
  ...
  shareCalculation: 'Partager ce calcul',
  ...
  amortizationDesc: 'Ajoutez des paiements supplémentaires récurrents (par exemple, chaque année) ou uniques (par exemple, mois 10 de l\'année 4) pour réduire votre prêt plus rapidement.',
  recalculatePayment: 'Recalculer le paiement mensuel après chaque paiement supplémentaire',
  recalculateYes: '✓ Le paiement diminue chaque mois à mesure que le solde se réduit (vous payez moins d\'intérêts totaux)',
  ...
  // Titles
  mortgageCalcTitle: '🏠 Calculatrice Hypothécaire',
  mortgageCalcSubtitle: 'Calculez vos paiements hypothécaires mensuels',
  amortizationCalcTitle: '📊 Calculatrice d\'Amortissement',
  amortizationCalcSubtitle: 'Voir le calendrier détaillé d\'amortissement du prêt',
